...
/**
 * Returns a date string in ISO format from today plus numDays
 * @param {number} numDays - Number of days from today
 * @param {boolean} [withTime=false] - Include time in the returned string
